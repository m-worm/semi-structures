...
The supplied visual reference was traced to Aminext's nTSV
explainer.\ \cite{AminextBSP} The rendering below is a new solid-model
testcase, not a reproduction of that source.
